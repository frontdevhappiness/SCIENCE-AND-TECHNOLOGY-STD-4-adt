# Science Pupil's Book Standard Four — ADT Bundle Reference
...
**Science Pupil's Book Standard Four** — This is an English-language Science and Technology pupil’s book for Standard Four, roughly aimed at primary learners aged about 9–10, produced in Tanzania by the Tanzania Institute of Education. It covers health and hygiene, common diseases, matter, combustion, energy, and introductory computer coding, combining everyday examples with simple experiments, activities, illustrations and review exercises. The book reflects a competence-based, practical teaching approach that encourages observation, discussion, safety awareness and the application of science and technology to daily life in a Tanzanian context.
...
├── SCIENCE-AND-TECHNOLOGY-STD-4.db                    # SQLite database (pipeline state)
├── SCIENCE-AND-TECHNOLOGY-STD-4.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Official green Certificate of Approval for the Science Pupil’s Book Standard Four, issued by the United Republic of Tanzania Ministry of Education, Science and Technology.",
  "gl001": "abnormal",
  "gl001_def": "not usual or not normal"
}
```
...
```json
{
  "abnormal": {
    "word": "abnormal",
    "definition": "not usual or not normal",
    "variations": ["abnormal","abnormally"],
    "emoji": "⚠️❗"
  }
}
```
...
```json
{
  "title": "Science Pupil's Book Standard Four",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
| Original PDF | `SCIENCE-AND-TECHNOLOGY-STD-4.pdf` |
| Pipeline database | `SCIENCE-AND-TECHNOLOGY-STD-4.db` (SQLite) |
